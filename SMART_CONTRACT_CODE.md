# App Market Smart Contract - Complete Code

**File:** `/home/user/App-Market/programs/app-market/src/lib.rs`

**Version:** Enhanced with security fixes and offer system
...
1. Open this file in your code editor or browser
2. Use your browser's Print function (Ctrl+P / Cmd+P)
3. Select "Save as PDF" as the destination
4. Save the PDF

### Option 2: Using Pandoc (Best Formatting)
```bash
cd /home/user/App-Market
pandoc SMART_CONTRACT_CODE.md -o smart_contract.pdf --pdf-engine=xelatex -V geometry:margin=1in
```
...
- **Total Lines:** 2,721
- **Instructions:** 20
- **Structs:** 8 (MarketConfig, Listing, Escrow, Transaction, Dispute, PendingWithdrawal, Offer, OfferEscrow)
- **Enums:** 6 (ListingType, ListingStatus, TransactionStatus, DisputeStatus, DisputeResolution, OfferStatus)
- **Events:** 17
- **Errors:** 47
- **Security Features:** Withdrawal pattern, account closure safety, rent reclamation, validation ordering, grace periods, timelocks
- **New Features:** Offer system, reserve auction timing, auto-finalize, listing expiration

---

## Review Checklist

When reviewing this code, please verify:

- [ ] Withdrawal pattern prevents DoS attacks
- [ ] All account closures have correct rent recipients
- [ ] Validation order is correct (checks before state changes)
- [ ] No zero-amount transfers possible
- [ ] Grace periods work correctly (72h after seller confirmation)
- [ ] Reserve auction timing (timer starts only when reserve met)
- [ ] Offer lifecycle (create, cancel, accept, expire)
- [ ] Rent reclamation in all exit paths
- [ ] Checked arithmetic throughout
- [ ] Event emissions for all state changes

---

**End of Smart Contract Code**
